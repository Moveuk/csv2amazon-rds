...
public class ExcelDataController {
    ...
    public static final String FILE_PATH = "C:\\Users\\ldu\\Downloads\\202201\\";
    ...
    @GetMapping("/update/folder")
    public void readfolder() throws IOException, InvalidFormatException {

        //File Folder에서 리스트화
//
        String[] fileArray = new File(FILE_PATH).list();
        ...
        for (String file : fileArray) {
            ...
            // 엑셀 파일 불러오기
            OPCPackage opcPackage = OPCPackage.open(new File(FILE_PATH + file));
            XSSFWorkbook workbook = new XSSFWorkbook(opcPackage);
            String sheetName = workbook.getSheetName(0);    // 첫번째 시트 이름
            Sheet sheet = workbook.getSheet(sheetName); // 첫번째 시트 선택
